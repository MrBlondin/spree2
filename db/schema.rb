...
ActiveRecord::Schema.define(:version => 20130710164548) do
  ...
  create_table "spree_pages", :force => true do |t|
    ...
    t.string   "title_fi"
    t.text     "body_fi"
    t.string   "meta_keywords_fi"
    t.string   "meta_description_fi"
    t.string   "meta_title_fi"
    t.string   "submenu"
  end
  ...
  add_index "spree_tax_category_translations", ["spree_tax_category_id"], :name => "index_50d21f4c6517c5845837552c843090479fd2e08b"
