...
module Spree
  class Product < ActiveRecord::Base
    ...
    delegate_belongs_to :master, :old_price if Variant.table_exists? && Variant.column_names.include?('old_price')
    ...
    attr_accessible :old_price if Variant.table_exists? && Variant.column_names.include?('old_price')
